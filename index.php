					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>Auto</span>Salon</h1>
									<h2>Rolls-Royce Ghost Series II</h2>
									<p>Ghost Series II luôn là mẫu xe giữ vị trí số một về doanh số bán hàng của dòng xe siêu sang chính hãng tại Việt Nam. </p>
									<button type="button" class="btn btn-default get">Xem chi tiết</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>Auto</span>Salon</h1>
									<h2>Mercedes-Maybach S600</h2>
									<p>Hội đủ các yếu tố từ thiết kế, tính năng, vận hành, nội, ngoại thất... cao cấp bậc nhất trong tất cả các dòng xe của Mercedes. </p>
									<button type="button" class="btn btn-default get">Xem chi tiết</button>
								</div>
								<div class="col-sm-6">
							...
							<div class="product-image-wrapper">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="gio-hang.php"><i class="fa fa-credit-card"></i>Thanh toán</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tshirt" data-toggle="tab"><i class="fa fa-home"></i> Home</a></li>
