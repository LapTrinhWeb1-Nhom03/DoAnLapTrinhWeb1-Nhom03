                ...
                <tbody>
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">Sản phẩm</a></h4>
                                <h5 class="media-heading"> Tên sản phẩm <a href="#">Xe hơi</a></h5>
                        ...
                        <button type="button" class="btn btn-danger">
                            <span class="glyphicon glyphicon-remove"></span> Xóa khỏi giỏ hàng
                        </button></td>
                    </tr>
                    <tr>
                        <td>   </td>
                    ...
                    <tr>
                        ...
                        <button type="button" class="btn btn-success">
                            Tiến hành thanh toán <span class="glyphicon glyphicon-play"></span>
                        </button>
                    </a>
                    </td>
                    </tr>
